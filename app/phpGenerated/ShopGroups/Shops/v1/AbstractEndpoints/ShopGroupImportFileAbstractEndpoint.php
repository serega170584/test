...
abstract class ShopGroupImportFileAbstractEndpoint
{
	public const GRPC_INTERFACE_NAME = 'ShopGroups\Shops\v1\ShopGroupInterface';
	public const GRPC_INTERFACE_METHOD_NAME = 'ImportFile';
	public const GRPC_INTERFACE_REALIZATION = '\ShopGroups\Shops\v1\InnerGrpcControllers\ShopGroupInnerController';
	public const GRPC_INPUT_TYPE = '\ShopGroups\Shops\v1\ImportFileRequest';
	public const GRPC_OUTPUT_TYPE = '\ShopGroups\Shops\v1\ImportFileResponse';
	public const GRPC_ROUTE = 'ecom.shop_group_service.v1.ShopGroup.ImportFile';
	...
	public function __invoke(\ShopGroups\Shops\v1\ImportFileRequest $dto): \ShopGroups\Shops\v1\ImportFileResponse
	{
	...
	abstract protected function run(\ShopGroups\Shops\v1\ImportFileRequest $dto): \ShopGroups\Shops\v1\ImportFileResponse;
}
