...
abstract class ShopGroupGetShopsAbstractEndpoint
{
	public const GRPC_INTERFACE_NAME = 'ShopGroups\Shops\v1\ShopGroupInterface';
	public const GRPC_INTERFACE_METHOD_NAME = 'GetShops';
	public const GRPC_INTERFACE_REALIZATION = '\ShopGroups\Shops\v1\InnerGrpcControllers\ShopGroupInnerController';
	public const GRPC_INPUT_TYPE = '\ShopGroups\Shops\v1\GetShopsRequest';
	public const GRPC_OUTPUT_TYPE = '\ShopGroups\Shops\v1\GetShopsResponse';
	public const GRPC_ROUTE = 'ecom.shop_group_service.v1.ShopGroup.GetShops';
	...
	public function __invoke(\ShopGroups\Shops\v1\GetShopsRequest $dto): \ShopGroups\Shops\v1\GetShopsResponse
	{
	...
	abstract protected function run(\ShopGroups\Shops\v1\GetShopsRequest $dto): \ShopGroups\Shops\v1\GetShopsResponse;
}
